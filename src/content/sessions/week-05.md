...
how: A turbine standing still in moving air.
activity: Read a power curve, then predict fleet output at 3, 5, 8, 14 and 26 m/s.
spec:
  - you can read a power curve and describe its shape in words
...
not zero wind. Below cut-in the machine is not underperforming — it is not
participating.
...
We read a power curve carefully — cut-in, the steep middle, rated output, and
cut-out — and then use it to predict fleet output across five wind speeds. The
non-linearity does most of the teaching.
